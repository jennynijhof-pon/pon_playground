...
(0, test_1.test)('create Audi vehicle test data through API', async ({ playwright }) => {
...
`;
    await (0, promises_1.writeFile)(path_1.default.resolve(__dirname, '../../test-data/verhicles/audi-vehicles.ts'), fileContent);
    await (0, promises_1.writeFile)(path_1.default.resolve(__dirname, '../../test-data/verhicles/audi-vehicles.json'), JSON.stringify(vehicles, null, 2));
